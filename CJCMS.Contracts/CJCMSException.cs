...
namespace CJCMS.Contracts
{
    ...
    public class EmailUnableException : ApplicationException
    {
        public EmailUnableException(string message)
            : base(message)
        {
        }
    }

    public class EmailValidateException : ApplicationException
    {
